...
Voraussetzung: [04 — FreshRSS](./04-freshrss.md) abgeschlossen. Sealed Secrets sollten vor diesem Schritt eingerichtet sein (Secrets für DB-Passwort und Seafile SECRET_KEY).
